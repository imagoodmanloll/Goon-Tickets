...
- [x] SQLite database handling
- [x] HTML Transcript logging
- [x] Still interactable after restart
- [x] Support team commands & permissions
- [x] Ticket blacklist/unblacklist for certain user
- [x] Slash commands support
- [x] Multiplite ticket types

# 🔽 Installation:
- Ensure you have downloaded [Node.JS](https://nodejs.org)
